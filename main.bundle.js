...
AppRoutingModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [__WEBPACK_IMPORTED_MODULE_5__StockDashboardModule_stock_dashboard_module__["a" /* StockDashboardModule */], __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* RouterModule */], __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* RouterModule */].forRoot(appRoutes)],
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_3__angular_material__["f" /* MdSnackBar */], __WEBPACK_IMPORTED_MODULE_3__angular_material__["g" /* OVERLAY_PROVIDERS */], __WEBPACK_IMPORTED_MODULE_3__angular_material__["h" /* Overlay */], __WEBPACK_IMPORTED_MODULE_4__AppModule_services_status_notification_service__["a" /* StatusNotificationService */], __WEBPACK_IMPORTED_MODULE_3__angular_material__["i" /* OverlayContainer */],
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        ...
        declarations: [
            __WEBPACK_IMPORTED_MODULE_11__app_component__["a" /* AppComponent */], __WEBPACK_IMPORTED_MODULE_12__AppModule_navigation_navigation_component__["a" /* NavigationComponent */], __WEBPACK_IMPORTED_MODULE_18__rxjs_testing_rxjs_testing_component__["a" /* RxjsTestingComponent */]
        ],
        imports: [
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_13__AppModule_services_status_notification_service__["a" /* StatusNotificationService */], __WEBPACK_IMPORTED_MODULE_14__shared_modelServices_ImmutableService__["a" /* ImmutableService */], {
                provide: __WEBPACK_IMPORTED_MODULE_1__angular_core__["ErrorHandler"], useClass: __WEBPACK_IMPORTED_MODULE_16__shared__["CustomErrorHandler"]
            }]
    }),
...
var RxjsTestingComponent = (function () {
    ...
    RxjsTestingComponent.prototype.fromEvent = function () {
        ...
        //   };
        // }).filter(c => c.x < 500);
        this.source = __WEBPACK_IMPORTED_MODULE_1_rxjs_Rx__["Observable"].fromEvent(document, 'click').map(function (c) {
            return {
                x: c.clientX,
                y: c.clientY
            };
    ...
    RxjsTestingComponent.prototype.create = function () {
        ...
        this.source = __WEBPACK_IMPORTED_MODULE_1_rxjs_Rx__["Observable"].create(function (observer) {
            ...
            prod();
        }).map(function (x) { return x * 2; }).filter(function (x) { return x > 5; });
    };
...
NewsReaderModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        declarations: [
            __WEBPACK_IMPORTED_MODULE_1__news_reader_news_reader_component__["a" /* NewsReaderComponent */]
        ],
        entryComponents: [],
        imports: [
...
var StockTableComponent = (function () {
    ...
    StockTableComponent.prototype.chooseChipColor = function (value, upper, bottom, isReversed) {
        ...
        try {
            return value > upper ? top : (value <= upper && value >= bottom ? middle : lower);
        }
        catch (ex) {
            return '';
        }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_rest_interactor_service__ = __webpack_require__("../../../../../src/app/modules/StockDashboardModule/services/rest-interactor.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var StockViewChangerComponent = (function () {
    function StockViewChangerComponent(ngRedux, restInteractorService) {
        this.ngRedux = ngRedux;
...
StockViewChangerComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1__angular_redux_store__["NgRedux"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_redux_store__["NgRedux"]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_5__services_rest_interactor_service__["a" /* RestInteractorService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__services_rest_interactor_service__["a" /* RestInteractorService */]) === "function" && _d || Object])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__AppModule_services_status_notification_service__ = __webpack_require__("../../../../../src/app/modules/AppModule/services/status-notification.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__shared__ = __webpack_require__("../../../../../src/app/shared/index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__models__ = __webpack_require__("../../../../../src/app/modules/StockDashboardModule/models/index.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var RestInteractorService = (function () {
    function RestInteractorService(ngRedux, statusNotificationService, googleSheetService, stockAnalysisService, yahoo, http) {
        var _this = this;
        this.ngRedux = ngRedux;
        this.statusNotificationService = statusNotificationService;
    ...
    RestInteractorService.prototype.getDefaultListResults = function () {
        var _this = this;
        this.googleSheetService.checkAuth(true, function (x) { return _this.isAuthorized(); });
    };
    ...
    RestInteractorService.prototype.handleYahooResponse = function (nestedResults, tickers) {
        var _this = this;
        var vixModel = new __WEBPACK_IMPORTED_MODULE_7__models__["b" /* VixModel */]();
        var results = [];
        __WEBPACK_IMPORTED_MODULE_4_lodash__["forEach"](nestedResults, function (quotes) {
            __WEBPACK_IMPORTED_MODULE_4_lodash__["forEach"](quotes, function (quote) {
                var category = tickers.filter(function (x) { return x.ticker === quote.Symbol; })[0].category;
                var result = _this.stockAnalysisService.decorateQuote(quote, category);
                result.ChangeinPercent = parseFloat(result.ChangeinPercent);
                results.push(result);
                vixModel = _this.buildVixModel(vixModel, result);
            });
        });
...
RestInteractorService = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
    __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__angular_redux_store__["NgRedux"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_redux_store__["NgRedux"]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_5__AppModule_services_status_notification_service__["a" /* StatusNotificationService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__AppModule_services_status_notification_service__["a" /* StatusNotificationService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_6__shared__["GoogleSheetsService"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__shared__["GoogleSheetsService"]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_6__shared__["StockAnalysisService"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__shared__["StockAnalysisService"]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_6__shared__["YahooDataService"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__shared__["YahooDataService"]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_1__angular_http__["Http"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_http__["Http"]) === "function" && _g || Object])
...
var AutoSelectComponent = (function () {
    function AutoSelectComponent(cd) {
        var _this = this;
        this.cd = cd;
...
moduleParams.entryComponents = [__WEBPACK_IMPORTED_MODULE_4_app_modules_form_tests_reactive_form_DialogResultExampleDialog__["a" /* DialogResultExampleDialog */]];
...
FormTestsModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_4_app_modules_form_tests_reactive_form_DialogResultExampleDialog__["a" /* DialogResultExampleDialog */],
        ...
        entryComponents: [],
        imports: [__WEBPACK_IMPORTED_MODULE_11__angular_common__["b" /* CommonModule */], __WEBPACK_IMPORTED_MODULE_12__angular_forms__["g" /* FormsModule */], __WEBPACK_IMPORTED_MODULE_12__angular_forms__["l" /* ReactiveFormsModule */], __WEBPACK_IMPORTED_MODULE_10__angular_material__["b" /* MaterialModule */], __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* RouterModule */], __WEBPACK_IMPORTED_MODULE_13__angular_platform_browser_animations__["a" /* BrowserAnimationsModule */]],
...
var template = {
    imports: [__WEBPACK_IMPORTED_MODULE_0__angular_common__["b" /* CommonModule */], __WEBPACK_IMPORTED_MODULE_1__angular_forms__["g" /* FormsModule */], __WEBPACK_IMPORTED_MODULE_1__angular_forms__["l" /* ReactiveFormsModule */], __WEBPACK_IMPORTED_MODULE_3__angular_material__["b" /* MaterialModule */], __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* RouterModule */], __WEBPACK_IMPORTED_MODULE_11__angular_platform_browser_animations__["a" /* BrowserAnimationsModule */]],
    ...
    declarations: [__WEBPACK_IMPORTED_MODULE_5_app_modules_form_tests_reactive_form_reactive_form_component__["a" /* ReactiveFormComponent */], __WEBPACK_IMPORTED_MODULE_6_app_modules_form_tests_input_input_component__["a" /* InputComponent */], __WEBPACK_IMPORTED_MODULE_7_app_modules_form_tests_reactive_form_DialogResultExampleDialog__["a" /* DialogResultExampleDialog */], __WEBPACK_IMPORTED_MODULE_8_app_modules_form_tests_auto_select_auto_select_component__["a" /* AutoSelectComponent */], __WEBPACK_IMPORTED_MODULE_9_app_modules_form_tests_boolean_input_boolean_input_component__["a" /* BooleanInputComponent */]],
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DialogResultExampleDialog; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_material__ = __webpack_require__("../../../material/@angular/material.es5.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var DialogResultExampleDialog = (function () {
    ...
    DialogResultExampleDialog.prototype.save = function () {
        this.result.action = 'was saved';
        this.dialogRef.close(this.result);
    };
    DialogResultExampleDialog.prototype.cancel = function () {
...
var BooleanElementDescriptor = (function (_super) {
    ...
    function BooleanElementDescriptor(formControlName, Label, type, color, labelPositionTypes, trueLabel, falseLabel, defaultValue, required, isDisabled) {
        ...
        if (trueLabel === void 0) { trueLabel = undefined; }
        if (falseLabel === void 0) { falseLabel = undefined; }
...
module.exports = "<md-card>\r\n  <md-card-title>{{pageTitle}}</md-card-title>\r\n  <button md-raised-button color=\"primary\" (click)=\"openDialog()\">Open dialog</button>\r\n\r\n  <form novalidate (ngSubmit)=\"$event.preventDefault(); saveProduct($event);\" [formGroup]=\"productForm\">\r\n    <div *ngFor=\"let descriptor of descriptors\" [ngSwitch]=\"descriptor.type\">\r\n      <boolean-input *ngSwitchCase=\"'checkbox'\"\r\n        [type]=\"descriptor.type\"\r\n        [color]=\"descriptor.color\"\r\n        [isDisabled]=\"descriptor.isDisabled\"\r\n        [required]=\"descriptor.required\"\r\n        [defaultValue]=\"descriptor.defaultValue\"\r\n        [label]=\"descriptor.Label\"\r\n        [trueLabel]=\"descriptor.trueLabel\"\r\n        [falseLabel]=\"descriptor.falseLabel\"\r\n        [labelPosition]=\"descriptor.labelPosition\"\r\n        (onChange)=\"log($event)\"\r\n      ></boolean-input>\r\n\r\n      <boolean-input *ngSwitchCase=\"'slideToggle'\"\r\n        [type]=\"descriptor.type\"\r\n        [color]=\"descriptor.color\"\r\n        [isDisabled]=\"descriptor.isDisabled\"\r\n        [required]=\"descriptor.required\"\r\n        [defaultValue]=\"descriptor.defaultValue\"\r\n        [label]=\"descriptor.Label\"\r\n        [trueLabel]=\"descriptor.trueLabel\"\r\n        [falseLabel]=\"descriptor.falseLabel\"\r\n        [labelPosition]=\"descriptor.labelPosition\"\r\n        (onChange)=\"log($event)\"\r\n      ></boolean-input>\r\n\r\n      <auto-select *ngSwitchCase=\"'select'\" \r\n      [list]=\"descriptor.getList\" [placeholder]=\"descriptor.Label\" [getKey]=\"descriptor.getKey\"\r\n      [getDescription]=\"descriptor.getDescription\" type=\"select\" (onChange)=\"log($event)\"></auto-select>\r\n\r\n      <auto-select *ngSwitchCase=\"'autocomplete'\" \r\n      [list]=\"descriptor.getList\" [placeholder]=\"descriptor.Label\" [getKey]=\"descriptor.getKey\"\r\n      [getDescription]=\"descriptor.getDescription\" type=\"autocomplete\" (onChange)=\"log($event)\"></auto-select>\r\n\r\n      <auto-select *ngSwitchCase=\"'radio'\" \r\n      [list]=\"descriptor.getList\" [placeholder]=\"descriptor.Label\" [getKey]=\"descriptor.getKey\"\r\n      [getDescription]=\"descriptor.getDescription\" type=\"radio\" (onChange)=\"log($event)\"></auto-select>\r\n\r\n      <form-input *ngSwitchDefault\r\n      [parentFormGroup]=\"productForm\"\r\n      [displayMessage]=\"displayMessage\"\r\n      [formInputDescriptor]=\"descriptor\" (onChange)=\"log($event)\"></form-input>\r\n    </div>\r\n   <div formArrayName=\"tags\">\r\n      <div>\r\n        <button md-raised-button color=\"accent\" (click)=\"$event.preventDefault(); addTag();\">Add Tag</button>\r\n        <button md-raised-button color=\"warn\" (click)=\"$event.preventDefault(); deleteTag();\">Delete Tag</button>\r\n      </div>\r\n      <div *ngFor=\"let tag of tags.controls; let i=index\">\r\n        <md-input-container align=\"right\">\r\n          <input mdInput formControlName=\"{{i}}\" placeholder=\"Tag\" type=\"text\">\r\n          <md-hint class=\"errorMessage\" *ngIf=\"displayMessage[i]\">\r\n            {{displayMessage[i]}}\r\n          </md-hint>\r\n        </md-input-container>\r\n      </div>\r\n    </div>\r\nhere:{{selectedOption}}\r\n\r\n    <auto-select [list]=\"complex\" [placeholder]=\"'Select something...'\" [getKey]=\"getComplexKey\" [getDescription]=\"getComplexValue\" type=\"autocomplete\" (onChange)=\"log($event)\"></auto-select>\r\n    <auto-select [list]=\"complex\" [placeholder]=\"'Select something...'\" [getKey]=\"getComplexKey\" [getDescription]=\"getComplexValue\" type=\"select\" (onChange)=\"log($event)\"></auto-select>\r\n    <auto-select [list]=\"complex\" [placeholder]=\"'Select something...'\" [getKey]=\"getComplexKey\" [getDescription]=\"getComplexValue\" type=\"radio\" (onChange)=\"log($event)\"></auto-select>\r\n\r\n    <auto-select [list]=\"list\" [placeholder]=\"'Select something...'\" [getKey]=\"getStateKey\" [getDescription]=\"getStateValue\" type=\"autocomplete\" (onChange)=\"log($event)\"></auto-select>\r\n    <auto-select [list]=\"list\" [placeholder]=\"'Select something...'\" [getKey]=\"getStateKey\" [getDescription]=\"getStateValue\" type=\"select\" (onChange)=\"log($event)\"></auto-select>\r\n    <auto-select [list]=\"list\" [placeholder]=\"'Select something...'\" [getKey]=\"getStateKey\" [getDescription]=\"getStateValue\" type=\"radio\" (onChange)=\"log($event)\"></auto-select>\r\n\r\n    <md-card-actions>\r\n      <button md-raised-button color=\"primary\" type=\"submit\" [disabled]='!productForm.valid'>Save</button>\r\n      <button md-raised-button (click)=\"$event.preventDefault(); cancel($event);\">Cancel</button>\r\n      <button md-raised-button color=\"warn\" (click)=\"$event.preventDefault(); deleteProduct($event);\">Delete</button>\r\n    </md-card-actions>\r\n  </form>\r\n</md-card>\r\n"
...
var ReactiveFormComponent = (function () {
    ...
    ReactiveFormComponent.prototype.ngAfterViewInit = function () {
        ...
        var controlBlurs = this.formInputElements
            .map(function (formControl) { return __WEBPACK_IMPORTED_MODULE_3_rxjs_Rx__["Observable"].fromEvent(formControl.nativeElement, 'blur'); });
        // Merge the blur event observable with the valueChanges observable
        __WEBPACK_IMPORTED_MODULE_3_rxjs_Rx__["Observable"].merge.apply(__WEBPACK_IMPORTED_MODULE_3_rxjs_Rx__["Observable"], [this.productForm.valueChanges].concat(controlBlurs)).debounceTime(0).subscribe(function (value) {
    ...
    ReactiveFormComponent.prototype.openDialog = function () {
        var _this = this;
        var dialogRef = this.dialog.open(__WEBPACK_IMPORTED_MODULE_4_app_modules_form_tests_reactive_form_DialogResultExampleDialog__["a" /* DialogResultExampleDialog */], {
            height: '90vh',
            width: '100vw'
        });
    ...
    ReactiveFormComponent.prototype.addTag = function () { this.tags.controls.push(new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* FormControl */]()); };
    ReactiveFormComponent.prototype.deleteTag = function () { this.tags.controls.pop(); };
    ReactiveFormComponent.prototype.cancel = function ($event) { console.log('cancel', $event); };
    ReactiveFormComponent.prototype.saveProduct = function ($event) { console.log('saved', $event); };
    ReactiveFormComponent.prototype.deleteProduct = function ($event) { console.log('deleted', $event); };
...
var MetadataService = (function () {
    ...
    MetadataService.prototype.getFormDescriptors = function () {
        ...
        descriptors.push(new __WEBPACK_IMPORTED_MODULE_1_app_modules_form_tests_reactive_form_metadata_FormInputDescriptor__["a" /* FormInputDescriptor */]('email', 'Email Address', 'text', [new __WEBPACK_IMPORTED_MODULE_2_app_modules_form_tests_reactive_form_metadata_Validator__["a" /* Validator */]('email', __WEBPACK_IMPORTED_MODULE_10_app_modules_form_tests_reactive_form_EmailValidation__["a" /* EmailValidators */].validate(), 'A valid email is required.')]));
        ...
        descriptors.push(new __WEBPACK_IMPORTED_MODULE_1_app_modules_form_tests_reactive_form_metadata_FormInputDescriptor__["a" /* FormInputDescriptor */]('url', 'URL', 'url', [new __WEBPACK_IMPORTED_MODULE_2_app_modules_form_tests_reactive_form_metadata_Validator__["a" /* Validator */]('url', __WEBPACK_IMPORTED_MODULE_10_app_modules_form_tests_reactive_form_EmailValidation__["b" /* UrlValidators */].validate(), 'A valid URL is required.')]));
        ...
        descriptors.push(new __WEBPACK_IMPORTED_MODULE_1_app_modules_form_tests_reactive_form_metadata_FormInputDescriptor__["a" /* FormInputDescriptor */]('productName', 'Product Name', 'text', [new __WEBPACK_IMPORTED_MODULE_2_app_modules_form_tests_reactive_form_metadata_Validator__["a" /* Validator */]('required', __WEBPACK_IMPORTED_MODULE_3__angular_forms__["m" /* Validators */].required, 'Product name is required.'),
        ...
        descriptors.push(new __WEBPACK_IMPORTED_MODULE_1_app_modules_form_tests_reactive_form_metadata_FormInputDescriptor__["a" /* FormInputDescriptor */]('productCode', 'Product Code', 'text', [new __WEBPACK_IMPORTED_MODULE_2_app_modules_form_tests_reactive_form_metadata_Validator__["a" /* Validator */]('required', __WEBPACK_IMPORTED_MODULE_3__angular_forms__["m" /* Validators */].required, 'Product code is required.')]));
        descriptors.push(new __WEBPACK_IMPORTED_MODULE_1_app_modules_form_tests_reactive_form_metadata_FormInputDescriptor__["a" /* FormInputDescriptor */]('starRating', 'Star Rating (1-5)', 'number', [new __WEBPACK_IMPORTED_MODULE_2_app_modules_form_tests_reactive_form_metadata_Validator__["a" /* Validator */]('range', __WEBPACK_IMPORTED_MODULE_4_app_modules_form_tests_reactive_form_NumberValidators__["a" /* NumberValidators */].range(1, 5), 'Rate the product between 1 (lowest) and 5 (highest).')]));
...
var WebWorkerInteractor = WebWorkerInteractor_1 = (function () {
    function WebWorkerInteractor(worker, isInline) {
        if (isInline === void 0) { isInline = false; }
        if (isInline) {
            var js = WebWorkerInteractor_1.getFromInlineJS(worker);
...
WebWorkerInteractor = WebWorkerInteractor_1 = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injectable"])(),
    __metadata("design:paramtypes", [String, Boolean])
], WebWorkerInteractor);

var WebWorkerInteractor_1;
...
var GoogleSheetsAdapterMap = (function () {
    function GoogleSheetsAdapterMap() {
        GoogleSheetsAdapterMap.map['masterSheetAdapter'] = GoogleSheetsAdapterMap.masterSheetAdapter;
        GoogleSheetsAdapterMap.map['commonAdapter'] = GoogleSheetsAdapterMap.commonAdapter;
    }
...
ChannelService = __decorate([
    ...
    __param(1, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Inject"])('channel.config')),
...
var YahooDataService = (function () {
    ...
    YahooDataService.prototype.get = function (tickers, columns) {
        ...
        return this.http.get(url).map(function (x) {
            var body = x['_body'];
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "StockAnalysisService", function() { return __WEBPACK_IMPORTED_MODULE_4__modelServices__["a"]; });
...
var StockAnalysisService = (function () {
    ...
    StockAnalysisService.prototype.decorateQuote = function (yahooQuote, category) {
        yahooQuote.PriceBook = yahooQuote.PriceBook ? parseFloat(yahooQuote.PriceBook.toString()) : defaultValue;
        yahooQuote.PriceSales = yahooQuote.PriceSales ? parseFloat(yahooQuote.PriceSales.toString()) : defaultValue;
        yahooQuote.PERatio = yahooQuote.PERatio ? parseFloat(yahooQuote.PERatio.toString()) : defaultValue;
        yahooQuote.PEGRatio = yahooQuote.PEGRatio ? parseFloat(yahooQuote.PEGRatio.toString()) : defaultValue;
        yahooQuote.DividendYield = yahooQuote.DividendYield ? parseFloat(yahooQuote.DividendYield.toString()) : defaultValue;
        yahooQuote.DividendShare = yahooQuote.DividendShare ? parseFloat(yahooQuote.DividendShare.toString()) : defaultValue;
        yahooQuote.EarningsShare = yahooQuote.EarningsShare ? parseFloat(yahooQuote.EarningsShare.toString()) : defaultValue;
        var quote = JSON.parse(JSON.stringify(yahooQuote));
        quote.MarketCapitalization = !quote.MarketCapitalization ? -1 : quote.MarketCapitalization;
    ...
    StockAnalysisService.prototype.calculateRegressionPotential = function (yahooQuote) {
        var relativeVolume = +(((yahooQuote.YearHigh / yahooQuote.LastTradePriceOnly) - 1) * 100).toFixed(0);
        return relativeVolume;
    };
    StockAnalysisService.prototype.calculateRelativeVolume = function (yahooQuote) {
        var relativeVolume = +((yahooQuote.Volume / yahooQuote.AverageDailyVolume) * 100).toFixed(0);
        return relativeVolume;
    };
    ...
    StockAnalysisService.prototype.MovingAvgMeaning = function (yahooQuote) {
        var value = (yahooQuote.OneyrTargetPrice
            ? '(' + Math.round(((yahooQuote.OneyrTargetPrice / yahooQuote.LastTradePriceOnly - 1) * 100))
                + '% Target:' + yahooQuote.OneyrTargetPrice + ', '
            : '(') + 'MA50:' + yahooQuote.PercentChangeFromFiftydayMovingAverage + ') '
            + this.evaluateSeriesData(yahooQuote).text;
        return value;
    };
    StockAnalysisService.prototype.getDailyPercentChange = function (yahooQuote) {
        return +(((yahooQuote.LastTradePriceOnly / yahooQuote.PreviousClose) - 1) * 100).toFixed(2);
    };
    StockAnalysisService.prototype.getGrahamBuffettRatio = function (yahooQuote) {
        var value = +((22.5 / (yahooQuote.PriceBook * yahooQuote.PERatio)) * 100).toFixed(2);
        return value;
    };
    StockAnalysisService.prototype.evaluateFundamentalData = function (yahooQuote) {
        ...
        var result = +((yahooQuote.EarningsShare + yahooQuote.DividendShare) / yahooQuote.PriceSales).toFixed(2);
        return result;
    };
    StockAnalysisService.prototype.evaluateSeriesData = function (yahooQuote) {
        ...
        var isAboveMacd200 = yahooQuote.PercentChangeFromTwoHundreddayMovingAverage
            && yahooQuote.PercentChangeFromTwoHundreddayMovingAverage.toString().charAt(0) === '+';
        ...
        if (isTargetPriceAboveCurrent && isAboveMacd50 && isAboveMacd200) {
            mood = {
                text: 'Strong uptrend' + (yahooQuote.OneyrTargetPrice ? ': Expected to outperform.' : emptyString),
            ...
            if (!isTargetPriceAboveCurrent && isAboveMacd50 && isAboveMacd200) {
                mood = {
                    text: 'Strong uptrend' + (yahooQuote.OneyrTargetPrice ? ': Expected to under-perform.' : emptyString),
                ...
                mood = {
                    text: 'recovering from long-term fall' + (yahooQuote.OneyrTargetPrice ? ': Expected to continue recovery.' : emptyString),
                    cssClass: yahooQuote.OneyrTargetPrice ? labelSuccess : labelInfo
                };
            }
            else {
                if (!isTargetPriceAboveCurrent && isAboveMacd50 && !isAboveMacd200) {
                    mood = {
                        text: 'recovering from long-term fall' + (yahooQuote.OneyrTargetPrice ? ': Expected to move back lower' : emptyString),
                        cssClass: yahooQuote.OneyrTargetPrice ? labelDanger : labelInfo
                    };
                }
                else if (isTargetPriceAboveCurrent && !isAboveMacd50 && isAboveMacd200) {
                    mood = {
                        text: 'near-term falling off after strong growth' + (yahooQuote.OneyrTargetPrice ? ': Expected to resume rally.' : emptyString),
                        cssClass: yahooQuote.OneyrTargetPrice ? labelSuccess : labelInfo
                    };
                }
                else if (!isTargetPriceAboveCurrent && !isAboveMacd50 && isAboveMacd200) {
                    mood = {
                        text: 'near-term falling off after strong growth' +
                            (yahooQuote.OneyrTargetPrice ? ': Expected to continue moving lower.' : emptyString),
                        cssClass: yahooQuote.OneyrTargetPrice ? labelDanger : labelInfo
                    };
                }
                else if (isTargetPriceAboveCurrent && !isAboveMacd50 && !isAboveMacd200) {
                    mood = {
                        text: 'strong long-term downtrend' + (yahooQuote.OneyrTargetPrice ? ': Expected to begin recovery.' : emptyString),
                        cssClass: yahooQuote.OneyrTargetPrice ? labelWarning : labelInfo
                    };
                }
                else if (!isTargetPriceAboveCurrent && !isAboveMacd50 && !isAboveMacd200) {
                    mood = {
                        text: 'strong long-term downtrend' + (yahooQuote.OneyrTargetPrice ? ': Continued collapse expected.' : emptyString),
                        cssClass: yahooQuote.OneyrTargetPrice ? labelDanger : labelInfo
                    };
                }
            }
...
RootReducer.rootReducer = new RootReducer();
...
var devToolsExtension = (window.devToolsExtension) ? window.devToolsExtension() : function (f) { return f; };
...
SharedModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_2_app_shared_security_auth_module__["a" /* AuthModule */]
        ],
